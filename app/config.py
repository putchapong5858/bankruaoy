...
# วิชาที่บ้านครูอ้อยสอน — ใช้จัดกล่องแบบฝึกหัดให้ผู้ปกครองเลือกง่าย
# เรียงตามลำดับที่อยากให้แสดงบนหน้าเว็บ
SUBJECTS = [
    {"name": "คณิตศาสตร์",  "icon": "🔢", "color": "#26A5E0"},
    {"name": "ภาษาไทย",     "icon": "🇹🇭", "color": "#F2884B"},
    {"name": "ภาษาอังกฤษ",  "icon": "🔤", "color": "#3CC98A"},
    {"name": "วิทยาศาสตร์", "icon": "🔬", "color": "#A98BF0"},
    {"name": "เชาวน์ปัญญา", "icon": "🧠", "color": "#F27DA0"},
]

# ชื่อวิชาที่เคยพิมพ์ไว้แบบอื่น — เทียบให้ตรงกล่องเดียวกัน
SUBJECT_ALIASES = {
    "อังกฤษ": "ภาษาอังกฤษ",
    "english": "ภาษาอังกฤษ",
    "eng": "ภาษาอังกฤษ",
    ...
    "math": "คณิตศาสตร์",
    "วิทย์": "วิทยาศาสตร์",
    "วิทยาศาสตร": "วิทยาศาสตร์",
    "เชาว์ปัญญา": "เชาวน์ปัญญา",
    "เชาวน": "เชาวน์ปัญญา",
    "iq": "เชาวน์ปัญญา",
}

OTHER_SUBJECT = {"name": "อื่น ๆ", "icon": "📦", "color": "#7A8894"}

# ช่วงชั้นสำหรับแบบฝึกหัดที่ใช้ได้หลายระดับ — ระบบเทียบเป็น "ช่วง"
# เด็กทุกคนที่อยู่ระหว่างต้นช่วงถึงปลายช่วงจะเห็นชุดนั้น
LEVEL_RANGES = [
    "อนุบาล 2 - อนุบาล 3",
    "อนุบาล 3 - ป.1",
    "อนุบาล 2 - ป.1",
